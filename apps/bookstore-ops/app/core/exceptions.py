...
class InvalidFileFormatError(FileUploadError):
    ...
    def __init__(self, message: str = "不支持的文件格式", allowed_formats: Optional[list] = None):
...
class LLMServiceError(BookStoreBaseException):
    ...
    def __init__(self, message: str = "LLM服务调用失败", details: Optional[Dict[str, Any]] = None):
        super().__init__(message, HTTPStatusConstants.INTERNAL_SERVER_ERROR, details)
...
class VectorServiceError(BookStoreBaseException):
    ...
    def __init__(self, message: str = "向量服务操作失败", details: Optional[Dict[str, Any]] = None):
        super().__init__(message, HTTPStatusConstants.INTERNAL_SERVER_ERROR, details)
...
class RAGServiceError(BookStoreBaseException):
    ...
    def __init__(self, message: str = "RAG服务操作失败", details: Optional[Dict[str, Any]] = None):
        super().__init__(message, HTTPStatusConstants.INTERNAL_SERVER_ERROR, details)
...
class BookRecommendationError(RAGServiceError):
    ...
    def __init__(self, message: str = "书籍推荐生成失败", requirements: Optional[Dict[str, Any]] = None):
...
class InvalidConfigError(ConfigurationError):
    ...
    def __init__(self, message: str = "配置值无效", config_key: Optional[str] = None, config_value: Optional[Any] = None):
        details = {
...
class ValidationError(BookStoreBaseException):
    ...
    def __init__(self, message: str = "验证失败", field: Optional[str] = None, details: Optional[Dict[str, Any]] = None):
...
class InsufficientStockError(BusinessLogicError):
    ...
    def __init__(self, message: str = "库存不足", book_id: Optional[int] = None, available: Optional[int] = None):
        details = {
            "book_id": book_id,
            "available_stock": available
        } if book_id and available is not None else None
        super().__init__(message, details)
