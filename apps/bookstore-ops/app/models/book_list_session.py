...
from sqlalchemy import TIMESTAMP, BigInteger, Column, Integer, String, Text, JSON
...
class BookListSession(Base):
    ...
    request_id = Column(String(64), unique=True, nullable=False, index=True, comment="请求ID（UUID）")
