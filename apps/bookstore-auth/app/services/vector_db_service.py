                ...
                results.append(
                    {
                        ...
                        "semantic_description": book_metadata.get(
...
class VectorDBService:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.warning(
                f"Failed to connect to Qdrant: {e}. Using local in-memory vector database."
            )
            self.client = LocalVectorDB()
            self.use_local = True
                ...
                for book in books:
                    try:
                        ...
                        metadata = {
                            ...
                            "target_audience": [],
                            "tags": [],
                            "semantic_description": getattr(
                                book, "semantic_description", ""
                            ),
                        }
