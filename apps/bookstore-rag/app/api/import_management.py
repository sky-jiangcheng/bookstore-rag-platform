                ...
                for index, row in df.iterrows():
                    ...
                    try:
                        ...
                        if not barcode or not title:
                            ...
                            # 分析筛选标签
                            filter_analysis = book_filter_service.analyze_book(
                                title=title,
                                author=author,
                                publisher=publisher,
                                summary=summary,
                            ...
                            if existing_book:
                                ...
                                existing_book.filter_tags = filter_analysis["filter_tags"]
                                existing_book.matched_keywords = filter_analysis["matched_keywords"]
                                ...
                                try:
                                    ...
                                    new_book = BookInfo(
                                        ...
                                        embedding=embedding,
                                        filter_tags=filter_analysis["filter_tags"],
                                        matched_keywords=filter_analysis["matched_keywords"],
                                    )
                                    db.add(new_book)
