...
class MockVectorStore:
    ...
    def __init__(self):
        # 模拟书籍数据
        self.books = [
            {"id": 1, "title": "Python编程从入门到实践", "author": "Eric Matthes", "price": 89.0, "category": "Python", "embedding": [0.1, 0.2, 0.3]},
            {"id": 2, "title": "算法导论", "author": "Thomas Cormen", "price": 128.0, "category": "算法", "embedding": [0.2, 0.3, 0.4]},
            {"id": 3, "title": "深度学习", "author": "Ian Goodfellow", "price": 168.0, "category": "机器学习", "embedding": [0.3, 0.4, 0.5]},
            {"id": 4, "title": "Java核心技术", "author": "Cay Horstmann", "price": 149.0, "category": "Java", "embedding": [0.15, 0.25, 0.35]},
            {"id": 5, "title": "数据结构与算法分析", "author": "Mark Allen Weiss", "price": 79.0, "category": "算法", "embedding": [0.25, 0.35, 0.45]},
        ]
...
def get_popular_books_tool(category: str | None = None, limit: int = 10) -> List[Dict]:
    """
    获取热门书籍
...
def register_all_tools():
    ...
    tool_registry.register(
        ...
        parameters={
            "book_ids": {"type": "array", "description": "书籍ID列表"}
        }
    )
