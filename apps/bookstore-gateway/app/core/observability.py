...
from app.core.tracing import initialize_jaeger_tracer, get_jaeger_tracer, TracingContext
from app.core.logging_config import setup_logging, get_logger, LogContext
...
def trace_and_log_operation(operation: str):
    ...
    def decorator(func):
        async def async_wrapper(*args, **kwargs):
            with LogContext(operation) as ctx:
                tracer = get_jaeger_tracer()
                if tracer:
                    with TracingContext(operation) as span:
