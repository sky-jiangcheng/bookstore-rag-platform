...
class ServiceOrchestrator:
    ...
    async def parse_requirements(
        ...
        try:
            ...
            # 使用解析器解析需求
            parsed_reqs, confidence_score, suggestions = (
    ...
    async def refine_requirements(
        ...
        try:
            ...
            if manual_adjustments:
                after_reqs, changes_summary = (
                    self._process_manual_refinement(before_reqs, manual_adjustments)
                )
            else:
                after_reqs, changes_summary = (
    ...
    def _process_manual_refinement(
        ...
        if "categories" in manual_adjustments:
            ...
            after_reqs_dict["categories"] = [c.model_dump() for c in category_requirements]
    ...
    def _save_book_list(
        ...
        book_list = CustomBookList(
            ...
            parsed_requirements=parsed_requirements.model_dump(),
            book_list=[r.model_dump() if hasattr(r, "model_dump") else r for r in recommendations],
            status="completed",
