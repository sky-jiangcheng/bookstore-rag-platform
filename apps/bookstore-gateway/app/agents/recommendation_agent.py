...
class RecommendationAgent:
    ...
    def _plan_categories(
        ...
        for i, cat in enumerate(categories):
            ...
            # 标准化百分比
            normalized_pct = (percentage / total_percentage) * 100 if total_percentage > 0 else percentage
...
if __name__ == "__main__":
    # 创建模拟候选书籍
    candidates = [
        BookCandidate(1, "Python编程从入门到实践", "Eric Matthes", "人民邮电出版社", 89.0, 100, "Python", 0.95, "vector"),
        BookCandidate(2, "算法导论", "Thomas Cormen", "机械工业出版社", 128.0, 50, "算法", 0.88, "database"),
        BookCandidate(3, "深度学习", "Ian Goodfellow", "人民邮电出版社", 168.0, 30, "机器学习", 0.82, "vector"),
        BookCandidate(4, "Java核心技术", "Cay Horstmann", "机械工业出版社", 149.0, 80, "Java", 0.75, "popular"),
        BookCandidate(5, "数据结构与算法分析", "Mark Allen Weiss", "机械工业出版社", 79.0, 60, "算法", 0.90, "database"),
    ]
    
    # 模拟需求
    requirement = {
        "target_audience": {"occupation": "程序员", "age_group": "成人", "reading_level": "进阶"},
        "categories": [{"name": "Python", "percentage": 60}, {"name": "算法", "percentage": 40}],
